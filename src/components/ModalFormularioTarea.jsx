...
const ModalFormularioTarea = () => {
    ...
    /*Extraccion del id que tenemos por url ya que es necesario para la creacion de la tarea*/
    ...
    //Effect para la edicion de registros
    useEffect(() =>{
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="text-lg leading-6 font-bold text-gray-900">
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            type="text" id='nombre' placeholder='Nombre de la tarea' value={nombre} onChange={e => setNombre(e.target.value)}/>
                                        </div>
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            id='descripcion' placeholder='Descripcion de la tarea' value={descripcion} onChange={e => setDescripcion(e.target.value)}/>
                                        </div>

                                        <div className='mb-5'>
                                            <label className='text-gray-700 uppercase font-bold text-sm ' htmlFor="fecha">Fecha Entrega:</label>
                                            <input className='border w-full p-2 mt-2 placeholder-gray-400 rounded-md' 
                                            type="date" id='fecha' value={fechaEntrega} onChange={e => setFechaEntrega(e.target.value)}/>
                                        </div>

                                        <div className='mb-5'>
                                            <label className='text-gray-700 uppercase font-bold text-sm ' htmlFor="prioridad">Prioridad:</label>
                                            <select className='border w-full p-2 mt-2 placeholder-gray-400 rounded-md' 
                                            type="text" id='prioridad'  value={prioridad} onChange={e => setPrioridad(e.target.value)}>
                                        ...
                                        <input className='bg-green-700 hover:bg-green-800 w-full text-white p-3 rounded uppercase cursor-pointer font-bold' type="submit"  value={id ? 'Actualizar tarea' : 'Crear tarea'}/>
